...
## 📝 Resumen Personal
Soy un estudiante de Ingeniería de Software apasionado por el desarrollo backend en Java. Me interesa construir aplicaciones seguras y escalables utilizando **Spring Boot, Spring Cloud y Spring Security**, tecnologías en las que ya cuento con certificaciones. Además, complemento mi perfil con conocimientos en **Docker, MySQL, Git/GitHub** y nociones de frontend con **HTML, CSS y TypeScript**.  
Mi meta es crecer profesionalmente en proyectos de **microservicios, cloud computing y programación con spring framework**, aportando soluciones eficientes y bien estructuradas, aportando al trabajo en equipo.
...
- **Git & GitHub**  
- **Docker**  
- Complemento: **HTML, CSS, TypeScript**
...
<!--
## 🚀 Próximos pasos
- Publicar proyectos académicos o personales en repositorios públicos.  
- Crear un **portafolio web** sencillo (ej. con HTML/CSS o React) y enlazarlo aquí.  
- Usar **readme.so** para añadir secciones visuales (badges, íconos, timeline).  
- Mantener actualizado tu perfil con nuevos certificados y proyectos.
